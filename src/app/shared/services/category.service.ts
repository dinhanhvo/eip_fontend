...
export class CategoryService {
    ...
    getAllCategories(): Observable<any> {
        const url = this.appStore.getData(AppStore.PROFILE, {}).api + '/categories';
    ...
    getCategory(id): Observable<any> {
        const url = this.appStore.getData(AppStore.PROFILE, {}).api + '/category/' + id;
    ...
    addCategory(cate): Observable<any>  {
        console.log('insert cate: ', cate);
        // url="http://localhost:8089/api/upload"
        const url = this.appStore.getData(AppStore.PROFILE, {}).api + '/category';
    ...
    editCategory(cate): Observable<any> {
